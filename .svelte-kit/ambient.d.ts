...
declare module '$env/static/private' {
	...
	export const npm_config_npm_config_disturl: string;
	...
	export const _INTELLIJ_FORCE_SET_GOFLAGS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		LESSOPEN: string;
		npm_config_npm_config_disturl: string;
		LANGUAGE: string;
		USER: string;
		...
		PWD: string;
		_INTELLIJ_FORCE_SET_GOFLAGS: string;
		npm_execpath: string;
