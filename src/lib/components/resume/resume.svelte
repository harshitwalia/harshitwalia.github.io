...
<article class="resume">
    ...
    <section class="about">
        ...
        <p>
            I believe in making the world better by building simple, powerful, and robust software. My interests include algorithms, communications, and server software with a strong emphasis on elegance and
