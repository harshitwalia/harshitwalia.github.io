...
<ul class="resume-contact">
	<li class="birthday">
		...
		<span>{calcYearsSince('1997-01-21')} years old</span>
	</li>
	<li class="experience">
	...
	<li class="linkedin">
		...
		<a href="https://www.linkedin.com/in/harshit-walia/" target="_blank"> LinkedIn Profile </a>
	</li>
	<li class="website">
	...
	<li class="github">
		...
		<a href="https://github.com/harshitwalia" target="_blank"> GitHub Profile </a>
	</li>
	<li class="languages">
